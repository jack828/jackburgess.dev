...
tags: ['TMUX', 'C']
lastmod: '2022-06-12'
summary: 'Because when the need for speed is too great, you always go a level down.'
---

# TMUX Statusline in C

![My finished statusline](/static/images/blogs--tmux-statusline-in-c--statusline-complete.png)
