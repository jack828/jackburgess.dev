...
lastmod: '2022-06-01'
summary: 'Upgrading a legacy codebase to use esbuild instead of Babel - how, and why?'
---
...
You can also see I’ve chosen to increase the target to ES2016 - [browser support for this](https://compat-table.github.io/compat-table/es2016plus) has reached a level I deem good enough to drop support for those browsers that haven’t yet caught up.
...
```js:build-esbuild.js {5,10,13,30,40}
const esbuild = require('esbuild')
